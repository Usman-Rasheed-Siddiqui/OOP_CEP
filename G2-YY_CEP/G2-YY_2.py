...
class Cars:
    ...
    def __init__(self, cars=[], brand="", model="", seating_capacity=0, price_per_day=0,no_of_cars=0, available=False):
        self.cars = cars
        self.brand = brand
    ...
    def __str__(self):
        return f"{self.display_car_info() if self.available else None}"

class Administrator(Cars):

    def __init__(self):
        Cars.__init__(self, cars=[], brand="", model="", seating_capacity=0, price_per_day=0, no_of_cars=0, available=True)
