    ...
    def create_an_account(self):
        ...
        while True:
            try:
                ...
                if self.quit_choice(self.last_name):
                    return
        ...
        while True:
            try:
                ...
                if self.quit_choice(self.address):
                    return
        ...
        while True:
            try:
                ...
                if self.balance > 10000000:
                    raise OverflowError("Balance can be at most 10000000 PKR")
                break
...
# -----------------------------------------RENTING AND RETURNING PROCESS-----------------------------------
    ...
    def renting(self):
        ...
        print("Although penalty will be charged if you return after return date\n")
        ...
        while True:
            try:
                ...
                if not model_found:
                    raise Exception("No Car with this model name found.")
            ...
            try:
                for user in users:
                    if user["email"].lower() == self.email.lower():
                        print()
                        if user["balance"] > 0:
                            print(f"Your current balance is {user["balance"]} PKR\n")
                        else:
                            print(f"{user["balance"] * -1} PKR will be deducted on next deposit\n")
                        ...
                        if user["balance"] + balance > 10000000:
                            raise OverflowError("Balance can be at most 10000000 PKR")
